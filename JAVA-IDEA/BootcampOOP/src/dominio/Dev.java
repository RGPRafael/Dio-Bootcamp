...
public class Dev {
    private String nome;
    // a ordem que se inscreve é preservada
    // um dev so se inscreve uma vez num conteudo
    // logo linkedHasset é melhor para aaarylist
    // pois so aceita elementos unicos..
